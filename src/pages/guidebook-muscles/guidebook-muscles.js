 ...
 */
var GuidebookMusclesPage = /** @class */ (function () {
    function GuidebookMusclesPage(alertCtrl, navCtrl, navParams) {
    ...
    GuidebookMusclesPage.prototype.ionViewDidLoad = function () {
        console.log("ionViewDidLoad GuidebookMusclesPage");
    };
    GuidebookMusclesPage.prototype.showDetail = function (exerciceID) {
    ...
    GuidebookMusclesPage = __decorate([
        Component({
    ...
    return GuidebookMusclesPage;
}());
export { GuidebookMusclesPage };
//# sourceMappingURL=guidebook-muscles.js.map